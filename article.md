...
<!-- #region citation-manager={"citations": {"cite2c-8908013/AIMIM5RK": [{"id": "8908013/AIMIM5RK", "source": "cite2c"}]}} -->
...
```python tags=["hermeneutics", "figure-3-*"]
from IPython.display import Image 
metadata={
    "jdh": {
        "module": "object",
...
```python tags=["hermeneutics", "figure-4-*"]
from IPython.display import Image 
metadata={
    "jdh": {
        "module": "object",
...
```python tags=["figure-8-*", "hermeneutics"]
from IPython.display import Image 
metadata={
    "jdh": {
        "module": "object",
...
```python tags=["hermeneutics", "figure-9-*"]
from IPython.display import Image 
metadata={
    "jdh": {
        "module": "object",
...
```python tags=["hermeneutics", "figure-10-*"]
from IPython.display import Image 
metadata={
    "jdh": {
        "module": "object",
...
```python tags=["hermeneutics", "figure-17-*"]
from IPython.display import Image 
metadata={
    "jdh": {
        "module": "object",
...
```python tags=["hermeneutics", "figure-18-*"]
from IPython.display import Image 
metadata={
    "jdh": {
        "module": "object",
...
```python tags=["hermeneutics", "figure-19-*"]
from IPython.display import Image 
metadata={
    "jdh": {
        "module": "object",
...
```python tags=["hermeneutics", "figure-20-*"]
from IPython.display import Image 
metadata={
    "jdh": {
        "module": "object",
...
<!-- #region tags=["hermeneutics"] -->
For the Plus/Delta exercise, as a first step, participants used post-it notes to write single words or short statements about the 25NR that they appreciated and placed these under the ‘Plus’ side of a large board, and for aspects that they felt needed improvement they placed the post-it notes on the the ‘Delta’ side of the board ([Figure 21](#anchor-figure-21-*)). The second step involved grouping the similar post-it notes into groups. The following sections summarise the results of this exercise. 
<!-- #endregion -->

```python tags=["hermeneutics", "figure-21-*"]
from IPython.display import Image 
metadata={
    "jdh": {
        "module": "object",
...
```python tags=["hermeneutics", "figure-22-*"]
from IPython.display import Image 
metadata={
    "jdh": {
        "module": "object",
